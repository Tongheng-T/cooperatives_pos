...
<section class="content container-fluid">
    ...
    $tbl_invoice_details = query("SELECT * from tbl_invoice_details where order_date between '$date_1' AND '$date_2'");
    confirm($tbl_invoice_details);

    $no = 1;
    $total = 0;
    while ($row = $tbl_invoice_details->fetch_object()) {
        $product_id = $row->invoice_id;
    ...
    <div class="box box-warning">
        <form action="" method="post" name="">
            ...
            <div class="box-body">
                ...
                $total_cost = $stotal - $row_cost->total_cost - $total;

                $total_jomnay = $row_cost->total_cost;
