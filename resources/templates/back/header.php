...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <!-- Logo -->
            <a href="itemt?dashboard" class="logo">
                <!-- mini logo for sidebar mini 50x50 pixels -->
                <span class="logo-mini"><b>P</b>OS</span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg"><b style="font-family: tong;">តំបែររុងរឿង</b>-POS</span>
            </a>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <img src="../productimages/a.png" class="user-image" alt="User Image">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    <img src="../productimages/a.png" class="img-circle" alt="User Image">
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="itemt?changepassword" class="btn btn-default btn-flat">Change
                                            password</a>
                                    </div>
